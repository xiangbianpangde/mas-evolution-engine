...
def run_benchmark():
    print("=" * 70)
    print("🧬 GENERATION 21 - Addressing Benchmark Weaknesses")
    print("=" * 70)
    print("IMPROVEMENTS:")
    ...
    os.makedirs("/root/.openclaw/workspace/mas_gen21_output", exist_ok=True)
    with open("/root/.openclaw/workspace/mas_gen21_output/benchmark_results.json", "w") as f:
        json.dump({
            "generation": 21,
