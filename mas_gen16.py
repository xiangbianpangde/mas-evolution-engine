...
MEMORY_FILE = "/root/.openclaw/workspace/mas_gen16_memory.json"
MAX_SUBTASKS = 3
...
def run_benchmark():
    print("=" * 60)
    print("🧬 GENERATION 16 - Convergence Check")
    print("=" * 60)
    ...
    # Save
    os.makedirs("/root/.openclaw/workspace/mas_gen16_output", exist_ok=True)
    with open("/root/.openclaw/workspace/mas_gen16_output/benchmark_results.json", "w") as f:
        json.dump({
            "generation": 6,
