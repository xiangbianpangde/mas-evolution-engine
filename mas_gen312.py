#!/usr/bin/env python3
"""Gen 312 - Neurosymbolic Integration"""
import json
import os
...
with open("mas_gen312_output/benchmark_results.json", "w") as f:
    json.dump({"generation": 312, "total_score": total}, f)