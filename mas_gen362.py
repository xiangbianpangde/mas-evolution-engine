#!/usr/bin/env python3
"""Gen 362 - Attention Schema Theory"""
import json
import os
...
total = 0.0
results = {}
print("GEN 362 - ATTENTION SCHEMA THEORY")
for bench in B:
    cfg = B[bench]
...
os.makedirs("mas_gen362_output", exist_ok=True)
with open("mas_gen362_output/benchmark_results.json", "w") as f:
    json.dump({"generation": 362, "total_score": total}, f)